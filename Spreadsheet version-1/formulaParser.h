...
class FormulaParser {
 ...
 private:
    ...
    static bool isValid(const SpreadSheet& table, const string& str); 
    
    static bool isValid(const SpreadSheet& table ,const Cell& cell);  

    static bool isValid(SpreadSheet table,const vector<string> &element);
